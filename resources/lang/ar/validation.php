...
return [
  ...
  */
    ...
    'img' => 'يجب أن يكون :attribute صورةً',
    ...
    'required_unless' => ':attribute مطلوب في حال ما لم يكن :other  :values.',
  ...
  */
  ...
  'attributes' => [
        ...
        'number_of_pregnancy' => 'عدد مرات الحمل',
        'birth_method' => 'عدد مرات الحمل',
        'contraceptive' => 'موانع الحمل',
        'family_hereditary_diseases' => 'الامراض الوراثية العائلية',
        'family_hereditary_diseases_type' => 'نوع المرض الوراثي',
        'water_per_day' => 'كمية المياه في اليوم',
        'food_salinity' => 'ملوحة الطعام',
        'sports_activity' => 'النشاطات الرياضية',
        'other_health_problems' => 'مشاكل صحية اخرى',
        'lab_tests_last_three_months' => 'تحاليل اخر 3 شهور',
        'cholesterol' => 'الكوليسترول',
        'low_blood_pressure' => 'انخفاض ضغط الدم',
        'colon_problems' => 'مشاكل القولون',
        'ectoderm' => 'قرحة المعدة',
        'anemia' => 'فقر الدم',
        'vitamin_d_deficiency' => 'نقص فيتامين د',
        'pregnancy_breastfeeding' => 'الرضاعة الطبيعية أثناء الحمل',
        'supplements' => 'المكملات الغذائية',
        'liver_problems' => 'مشاكل في الكبد',
        'kidney_problems' => 'مشاكل في الكلى',
        'smoking' => 'التدخين',
        'knee_roughness' => 'خشونة الركبة',
        'gout' => 'النقرس',
        'last_week_diet_model' => 'نموذج غذائي لاخر اسبوع',
        'lab_tests_result' => 'نتائج التحاليل',
        'hair_loss' => 'تساقط الشعر',
        'thyroid_gland_laziness' => 'كسل الغدة الدرقية',
        'Neck_back_pain' => 'آلام الظهر والرقبة',
        'hormonal_disorder' => 'اضطراب الهرمونات',
        'ovarian_cysts' => 'تكيسات المبايض',
        'diabetes' => 'السكري',
        'diabetes_type' => 'نوع السكري',
        'food_allergy' => 'حساسية الطعام',
        'food_allergy_type' => 'نوع حساسية الطعام',
        'digestive_problems' => 'مشاكل في الجهاز الهضمي',
        'digestive_problems_type' => 'نوع مشاكل الجهاز الهضمي',
        'day' => 'اليوم',
        'month' => 'الشهر',
        'year' => 'السنة',
        'hour' => 'ساعة',
...
//        'phone' => 'الموبايل العام',
        ...
        'lat' => 'الموقع على الخريطة (خط العرض)',
        'long' => 'الموقع على الخريطة (خط الطول)',
...
//        'branches_merchandiser.*.id' => 'العميل',
      ...
      //
        ...
        'company_phone' => 'رقم المنشأة',
        'emp_name' => 'اسم المفوض',
        'emp_phone' => 'رقم الهاتف',
        'partition' => 'القسم',
        'message' => "الرسالة",
        "comm_file" => 'الملف التجاري',
        "home_title_en" => "عنوان القسم الرئيسي بالانجليزية",
        "home_title_ar" => "عنوان القسم الرئيسي بالعربية",
        "who_title_en" => "عنوان قسم من نحن بالانجليزية",
        "who_title_ar" => "عنوان قسم من نحن بالعربية",
        "who_desc_en" => "وصف قسم من نحن بالانجليزية",
        "who_desc_ar" => "وصف قسم من نحن بالعربية",
        "who_more_desc_en" => "وصف قسم من نحن الاضافي بالانجليزية",
        "who_more_desc_ar" => "وصف قسم من نحن الاضافي بالعربية",
        "location_en" => "مكان التواجد بالانجليزية",
        "location_ar" => "مكان التواجد بالعربية",
        "facebook" => "فيسبوك",
        "twitter" => "تويتر",
        "instagram" => "انستاجرام",
        "snapchat" => "سناب شات",
        'chronic_en' => "الامراض المزمنة",
        'chronic_ar' => "الامراض المزمنة",
        "agile_body_en" => "الجسم الرشيق",
        "agile_body_ar" => "الجسم الرشيق",
        ...
        'specialist' => 'الأخصائي',
        'package' => 'الباقة',
        'free_consultation_duration' => 'مدة الاستشارة المجانية',
        'other_consultation_duration' => 'مدة الاستشارات الاخرى',
        'consultation_price_when_balance_out' => 'سعر الاستشارة عند نفاذ الرصيد بدون الضريبة',
        'duration_between_consultations' => 'المدة بين الاستشارات',
        'relative_relation' => 'صلة القرابة',
        'arr.*.key_en' => 'الخاصية انجليزي',
        'arr.*.key_ar' => 'الخاصية عربي',
        "arr.*.descs.*.desc_en" => 'الوصف انجليزي',
        "arr.*.descs.*.desc_ar" => 'الوصف عربي',
        "arr.*.descs.*.added_price" => 'السعر المضاف',
        "price_before" => "السعر قبل الخصم",
        "price_after" => "السعر بعد الخصم",
        "start_date" => "تاريخ بدء العرض",
        "end_date" => "تاريخ نهاية العرض",
        "products.*.shop_product_id" => "المنتج",
        "products.*.restaurant_product_id" => "المنتج",
        "products.*.unit_price" => "سعر الوحدة",
        "products.*.qty" => "الكمية",
        "disc_percentage" => "نسبة الخصم",
        "num_uses" => "عدد مرات الاستخدام",
        "products.*.shop_product_id" => "المنتج",
        "duration" => "المدة",
        "branches" => "الفروع",
        "medical_test_id.*" => "التحاليل",
        "latitude" => "خط العرض",
        "longitude" => "خط الطول",
        "categ" => "التصنيف",
        "comm_file" => 'الملف التجاري',
        "addresses.*.title" => 'العنوان',
        "addresses.*.long" => 'خط الطول',
        "addresses.*.lat" => 'خط العرض',
        "addresses.*.street" => 'الشارع',
        "addresses.*.build_number" => 'رقم البناية',
        "countryValues" => "جميع قيم عمولة الدولة مطلوبة",
        "street" => "الشارع",
        "build_number" => "رقم البناية",
        "countries.*.value" => "العمولة",
        "types.*.value" => "العمولة",
        "countries.*.tax" => "الضريبة",
        "supplier_type" => "قسم الموردين",
        "supplier_phone" => "رقم هاتف مزود الخدمة",
        "contractable_id" => "المورد",
        "bank_name" => "اسم البنك",
        "iban" => "رقم الحساب البنكي",
        "registered_name_ar_nd_party" => "اسم المسجل  بالعربي",
        "registered_name_en_nd_party" => "اسم المسجل  بالانجليزي",
        "company_type_nd_party" => "نوع الشركة ",
        "contact_person_nd_party" => "مسؤول الاتصال",
        "position_nd_party" => "المنصب",
        "sales_commission_fees" => "النسبة المستحقة من اجمالي المبيعات الشهرية",
        "signatory_name_nd_party" => "الموقع",
        "signature_nd_party" => "التوقيع",
        "signatory_Position_nd_party" => "منصب الموقع",
        "date_st_party" => "تاريخ توقيع المنصب الاول",
        "date_nd_party" => "تاريخ توقيع المنصب التاني",
        "trade_name" => "الاسم التجاري",
        "mobile_prefix" => "بادئة الهاتف",
        "timezone" => "المنطقة الزمنية",
        "currency_id" => "العملة",
        "country_id" => "الدولة",
        "countries.*.price" => "السعر",
        "product" => "المنتج",
        "product.branch_price" => "سعر الفرع",
        "calories" => "السعرات الحرارية",
        "protiens" => "البروتين",
        "fats" => "الدهون",
        "carbos" => "الكربوهيدرات",
        "meal_type" => "نوع الوجبة",
      "medicaltests.*.branch_price" => "سعر الفرع",
      "medicaltests.*.selected" => "التحليل مختار",
      "specialty_id" => "التخصص",
      "bank_account_number" => "رقم الحساب البنكي",
      "about_en" => "الوصف انجليزي",
      "about_ar" => "الوصف عربي",
      "certifications" => "الشهادات",
      "group_id" => "مجموعة التمارين",
      "descriptions" => "الوصف",
      "has_discount_code" => "هل يوجد كود خصم",
      "discount_code_name" => "اسم كود الخصم",
      "code_name" => "اسم كود الخصم",
      "discount_code_start_date" => "تاريخ البداية",
      "discount_code_end_date" => "تاريخ النهاية",
      "discount_code_percentage" => "نسبة الخصم",
      "discount_code_uses_number" => "عدد مرات الاستخدام",
      "uses_number" => "عدد مرات الاستخدام",
