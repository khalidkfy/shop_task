<template>
    <div>
        <label class="  ">{{label ? label : name}} <span class="text-danger d-inline-block mx-2" v-if="required">*</span> </label>
        <el-upload
            :accept="fileType"
    ...
    export default {
        ...
        methods: {
            ...
            handleError(err, file, fileList) {
                this.file_error = __("File must be from type: .jpg, .jpeg, .png")
                // console.log(file);
